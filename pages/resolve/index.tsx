...
const Airdrop: NextPage = () => {
  ...
  return (
    <div className="h-3/4 w-3/4">
      ...
      <div className="max-h-full my-6 overflow-y-scroll overflow-x-visible scrollbar-thin scrollbar-thumb-jackal-light scrollbar-track-jackal-dark ">
        <form
          className="container mx-auto grid gap-x-2 gap-y-1 grid-cols-6 justify-items-center items-center pr-3"
        ...
        >
          <div className="col-span-5 h-full w-full block grid grid-cols-8">
            <input
              ...
              id="nmval"
              type="text"
              className="col-span-7 h-full bg-gray-50 box-content border-gray-300 text-black text-2xl rounded-l-lg px-4 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500"
          ...
          <button
            ...
            col-span-1 h-full p-2 rounded-md text-2xl block w-full`}
          >
            Resolve
          </button>
          ...
          <input
            ...
            type="text"
            readOnly
            className="col-span-6 h-full py-2 w-full box-border bg-gray-50 border-gray-300 text-black text-2xl rounded-lg px-4 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500"
            placeholder={'Address'}
          />
