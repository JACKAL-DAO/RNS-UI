    ...
    <div className="min-w-[250px] h-full border-r-[1px] border-r-plumbus-light pt-5 pb-8 px-5 flex flex-col bg-black/50">
      ...
      <div className="ml-3">
        <Link href="/howto" passHref>
          <button className="flex items-center my-3">
            <ImArrowUpRight2 className="mr-2" /> How-To Video
          </button>
        </Link>
        <a
      ...
      <div className="mt-5 flex items-center justify-evenly">
        <a
          ...
          rel="noreferrer"
        >
          <button name="discord" className="flex items-center">
            <SiDiscord size={20} />
          </button>
        </a>
        <a
          ...
          className="ml-5"
        >
          <button name="telegram" className="flex items-center">
            <SiTelegram size={20} />
          </button>
        </a>
        <a
          ...
          className="ml-5"
        >
          <button name="twitter" className="flex items-center">
            <ImTwitter size={20} />
          </button>
        </a>
        <a
          ...
          className="ml-5"
        >
          <button name="github" className="flex items-center">
            <ImGithub size={20} />
          </button>
        </a>
      </div>
